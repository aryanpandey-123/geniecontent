  ...
  return (
    <nav
      className={`nav-shift
        ...
        bg-white backdrop-blur-md border-b border-white/40
        px-4 py-4 flex items-center justify-between ${navbarLeftClass}`}
    >
      <button
      ...
      <Link
        ...
        className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-all duration-200 hover:scale-105 shadow-sm"
      >
