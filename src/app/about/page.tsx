...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-green-100 to-purple-100 flex items-center justify-center p-8 font-sans">
            <div className="relative bg-white/70 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 max-w-6xl w-full text-center h-[650px] sm:h-[500px] md:h-600px] lg:h-[650px] overflow-y-scroll">
                ...
                <h1 className="text-3xl lg:text-4xl font-extrabold text-gray-900 leading-tight mb-8">About Us</h1>
                <h2 className="text-xl lg:text-2xl font-bold text-left text-gray-900 mb-2">Our Mission</h2>
                <div className="text-gray-900 text-[15px] md:text-lg">
                ...
                {/* temporary work */}
                <hr className="h-1 bg-green-100"/>
                <h2 className="text-xl lg:text-2xl font-bold text-left text-gray-900 mb-2">Why</h2>
                <div className="text-gray-900 text-[15px] md:text-lg">
                    <p className=" leading-relaxed text-justify mb-6">
                        We created this content generation web app to solve a common problem: creating quality content takes time, effort, and creativity. Many students, professionals, and small businesses struggle to come up with fresh ideas or write engaging text quickly.
                    </p>
                    <p className=" leading-relaxed text-justify mb-6">
                        We build this app to:
                    </p>
                    <ul className=" leading-relaxed text-justify mb-6">
                        <li><strong>Save Time :</strong> Generate content instantly instead of spending hours writing from scratch.</li>
                        <li><strong>Boost Creativity :</strong> Provide fresh ideas when you feel stuck.</li>
                        <li><strong>Make it Accessible :</strong> Offer an easy-to-use tool for everyone, from beginners to professionals.</li>
                    </ul>
                </div>
                {/* temporary work */}
            </div>
