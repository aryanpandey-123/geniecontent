...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-green-100 to-purple-100 flex items-center justify-center p-8 font-sans">
      <div className="relative bg-white rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 max-w-6xl w-full text-center">
        ...
        <nav className="flex items-center justify-between mb-12">
          ...
          <div className="flex items-center">
            <button className="text-gray-700 font-medium px-4 py-2 hover:bg-gray-200 rounded-md transition">
              About
            </button>
          </div>
        </nav>
        ...
        <div className="flex justify-center space-x-4 pt-12 mt-12 border-t border-gray-100">
          <div className="flex items-center bg-gray-50 rounded-full py-2 px-6 text-gray-700 font-medium shadow-sm">
